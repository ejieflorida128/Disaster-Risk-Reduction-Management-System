    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-bs-dismiss="modal" onclick = "refreshIfClose()">Close</button>
            ...
            <div class="tableForTsunamiDisaster" id = "tableForTsunamiDisaster">
...
<script>
    $(document).ready(function () {
        ...
        $("#searchBar").on('input', function () {
            var value = $(this).val();
            DisplayTableForTsunami(value);
        });         
    });

    function DisplayTableForTsunami(value) {
        $.ajax({
            url: "ajax.php",
            type: 'post',
            data: {
                DisplayTableForTsunami: true,
                value:value
            },
            success: function (data, status) {
                console.log(data); // Check the data in the console
                $('#tableForTsunamiDisaster').html(data);                       
            }
        });
    }


    function DeleteFOrtsunamiDisaster(id){
        var id = id;
        $.ajax({
            url: "ajax.php",
            type: 'post',
            data: {
                DeleteTsunamiDisaster: true,
                id:id
    ...
    function ViewDetails(id){
        ...
        $.post("ajax.php", { TsunamiId: id }, function(data, status) {
